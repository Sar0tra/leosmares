...
const Footer = () => (
    <footer className="relative bg-black text-zinc-400 overflow-hidden border-t border-white/10 select-none">
        ...
        <span className="absolute -bottom-6 left-1/2 -translate-x-1/2 text-[5rem] sm:text-[8rem] md:text-[12rem] font-black uppercase tracking-tighter text-transparent [-webkit-text-stroke:1.5px_rgba(255,255,255,0.06)] leading-none pointer-events-none whitespace-nowrap">
            LEOŠ MAREŠ
        </span>

        {/* Světelná záře */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[500px] h-[250px] bg-amber-500/10 blur-[120px] pointer-events-none rounded-full" />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 py-12">
                ...
                <div className="sm:col-span-2 md:col-span-1">
                    ...
                    <p className="mt-3 text-sm text-zinc-500 font-light leading-relaxed max-w-xs">
                    ...
                    <div className="flex items-center gap-3 mt-6">
                        {socialLinks.map((s) => (
                            <a
                                ...
                                aria-label={s.label}
                                className="w-10 h-10 flex items-center justify-center rounded-full border border-white/15 text-zinc-400 hover:text-amber-400 hover:border-amber-500/60 transition-all duration-200"
                            >
                                {s.icon}
                            </a>
                        ))}
                ...
                <div>
                    ...
                    <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 mt-4 text-sm font-semibold text-white hover:text-amber-400 transition-colors duration-200"
                    >
                        Vstupenky
